...
MODULES  := arch/arm64 assert errno stdio string
...
ASFLAGS := $(INCLUDES) -MMD
LDFLAGS := -L../jlibc -ljlibc
...
clean:
	...
	-rm $(OBJFILES) $(OBJFILES:.o=.d) $(ALIBNAME) 2>/dev/null
	-cd $(CHKDIR) && make clean
